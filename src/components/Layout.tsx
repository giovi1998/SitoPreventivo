      ...
      <aside className="sidebar">
        ...
        <nav aria-label="Navigazione principale">
          ...
          <button title="Sito Web" className={view === 'website' ? 'active' : ''} onClick={() => setView('website')}>
            ...
            <span className="nav-label">Sito Web</span>
          </button>
          )}
          {user && (
            <>
        ...
        <div className="drawer-overlay" onClick={() => setDrawerOpen(false)}>
          <aside className="mobile-drawer" onClick={e => e.stopPropagation()}>
            ...
            <nav className="drawer-nav">
              ...
              <button className={view === 'flyer' ? 'active' : ''} onClick={() => nav('flyer')}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                  <polyline points="14 2 14 8 20 8" />
                  <line x1="8" y1="13" x2="16" y2="13" />
              ...
              <button className={view === 'social' ? 'active' : ''} onClick={() => nav('social')}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  <circle cx="18" cy="5" r="3" />
                  <circle cx="6" cy="12" r="3" />
                  <circle cx="18" cy="19" r="3" />
              ...
              {user?.role === 'admin' && (
              <button className={view === 'website' ? 'active' : ''} onClick={() => nav('website')}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  <circle cx="12" cy="12" r="10" />
                  <line x1="2" y1="12" x2="22" y2="12" />
                  <path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" />
              ...
              <span className="nav-group-label" aria-hidden="true">ARCHIVIO</span>
              {user?.role === 'admin' && (
                <button className={view === 'customers' ? 'active' : ''} onClick={() => nav('customers')}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></svg>
                  Clienti
                </button>
              )}
