...
| `src/server/{db,core,schemas,crm,ai,types}.ts` | Split modulare: Drizzle schema/getDb, supporto (CORS/rate-limit/validate/admin), Zod schemas, CRM research/Firecrawl, endpoint AI, tipi condivisi |
